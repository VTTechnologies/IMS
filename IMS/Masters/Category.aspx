<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="IMS.Category" %>
...
<head runat="server">
    ...
    <!-- Page-Level CSS -->
   <%-- <link href="../ssets/plugins/morris/morris-0.4.3.min.css" rel="stylesheet" />--%>
        ...
        <div class="container">
            <div class="panel panel-default text-center">
                ...
                <div class="panel-footer">
                    ...
                    <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary " ValidationGroup="abc" Text="Save" OnClick="btnSave_Click" OnClientClick="DisableOnSave(this,'abc');" UseSubmitBehavior="false"/>
