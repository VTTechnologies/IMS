...
namespace IMSBLL.EntityModel
{
    ...
    public partial class IMS2Entities : DbContext
    {
        public IMS2Entities()
            : base("name=IMS2Entities")
        {
        }
        ...
        public virtual DbSet<tbl_salesreturn> tbl_salesreturn { get; set; }
...
<<<<<<< .mine
        ...
        public virtual DbSet<tbl_purchasereturnmain> tbl_purchasereturnmain { get; set; }
        public virtual DbSet<tbl_salereturnmain> tbl_salereturnmain { get; set; }
...
>>>>>>> .r242
        ...
        public virtual int sp_Register(string company_name, string first_name, string last_name, string owner_emailid, string owner_mobileno, string user_password, Nullable<int> country_id, string pincode, string created_by, Nullable<System.DateTime> created_date, string start_date, string end_date, string uniqueidentity)
        {
            var company_nameParameter = company_name != null ?
                new ObjectParameter("company_name", company_name) :
                new ObjectParameter("company_name", typeof(string));
        ...
        public virtual int sp_UpdateCompany(Nullable<int> company_id, string company_name, string company_address, Nullable<int> state_id, string city, string telephone_no, string fax_no, string website, byte[] logo, string logo_name, string gSTIN, string modified_by, Nullable<System.DateTime> modified_date)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
        ...
        public virtual ObjectResult<Nullable<decimal>> sp_SelectTaxpercent(Nullable<int> company_id, Nullable<int> product_id)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("sp_SelectTaxpercent", company_idParameter, product_idParameter);
        }
        ...
        public virtual int sp_Purchaseinsert(Nullable<int> company_id, Nullable<int> branch_id, Nullable<int> party_id, string po_no, string po_Date, Nullable<decimal> total_tax, Nullable<decimal> actual_amount, Nullable<decimal> grand_total, Nullable<decimal> discount, string created_by, Nullable<System.DateTime> created_date, ObjectParameter purchase_id)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Purchaseinsert", company_idParameter, branch_idParameter, party_idParameter, po_noParameter, po_DateParameter, total_taxParameter, actual_amountParameter, grand_totalParameter, discountParameter, created_byParameter, created_dateParameter, purchase_id);
        }
        ...
        public virtual int sp_Salesinsert(Nullable<int> company_id, Nullable<int> branch_id, Nullable<int> party_id, string invoice_no, Nullable<decimal> total_tax, Nullable<decimal> actual_amount, Nullable<decimal> grand_total, Nullable<decimal> total_discount, string created_by, Nullable<System.DateTime> created_date, ObjectParameter sale_id)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_Salesinsert", company_idParameter, branch_idParameter, party_idParameter, invoice_noParameter, total_taxParameter, actual_amountParameter, grand_totalParameter, total_discountParameter, created_byParameter, created_dateParameter, sale_id);
        }
        ...
        public virtual ObjectResult<sp_SelectPurchaseinvoice_Result> sp_SelectPurchaseinvoice(Nullable<int> company_id, Nullable<int> party_id, Nullable<int> purchase_id, Nullable<System.DateTime> start_date, Nullable<System.DateTime> end_date)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_SelectPurchaseinvoice_Result>("sp_SelectPurchaseinvoice", company_idParameter, party_idParameter, purchase_idParameter, start_dateParameter, end_dateParameter);
        }
        ...
        public virtual int sp_insert_purchase_return(Nullable<int> purchasedetails_id, Nullable<int> purchasereturnmain_id, Nullable<int> batch_id, Nullable<int> product_id, Nullable<decimal> tax_amt, Nullable<decimal> quantity, Nullable<decimal> amount, string created_by, string created_date)
        {
            var purchasedetails_idParameter = purchasedetails_id.HasValue ?
                new ObjectParameter("purchasedetails_id", purchasedetails_id) :
                new ObjectParameter("purchasedetails_id", typeof(int));
    
            var purchasereturnmain_idParameter = purchasereturnmain_id.HasValue ?
                new ObjectParameter("purchasereturnmain_id", purchasereturnmain_id) :
                new ObjectParameter("purchasereturnmain_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_insert_purchase_return", purchasedetails_idParameter, purchasereturnmain_idParameter, batch_idParameter, product_idParameter, tax_amtParameter, quantityParameter, amountParameter, created_byParameter, created_dateParameter);
        }
    
        public virtual ObjectResult<sp_SelectSalesReport_Result> sp_SelectSalesReport(Nullable<int> company_id, Nullable<int> partyid, string sale_id, Nullable<System.DateTime> fromdate, Nullable<System.DateTime> enddate)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_SelectSalesReport_Result>("sp_SelectSalesReport", company_idParameter, partyidParameter, sale_idParameter, fromdateParameter, enddateParameter);
        }
...
=======
        ...
        public virtual int sp_insertmony(Nullable<int> company_id, Nullable<int> branch_id, Nullable<int> party_id, string party_type, Nullable<decimal> payableamt, Nullable<decimal> reciveableamt, string created_by, string created_date)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
            ...
            var reciveableamtParameter = reciveableamt.HasValue ?
                new ObjectParameter("reciveableamt", reciveableamt) :
                new ObjectParameter("reciveableamt", typeof(decimal));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_insertmony", company_idParameter, branch_idParameter, party_idParameter, party_typeParameter, payableamtParameter, reciveableamtParameter, created_byParameter, created_dateParameter);
        }
        ...
        public virtual ObjectResult<byte[]> sp_selectcompanylogo(Nullable<int> company_id)
        {
            var company_idParameter = company_id.HasValue ?
                new ObjectParameter("company_id", company_id) :
                new ObjectParameter("company_id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<byte[]>("sp_selectcompanylogo", company_idParameter);
        }
