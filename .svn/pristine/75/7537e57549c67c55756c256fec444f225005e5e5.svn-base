<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="printsale.aspx.cs" Inherits="IMS.SalesFolder.printsale" %>
...
<head runat="server">
    ...
    <link href="invoicedesign/styles/bauhaus.css" rel="stylesheet" type="text/css" />
    <link href="invoicedesign/styles/bauhaus_print.css" media="print" rel="stylesheet" type="text/css" />
